                                ...
                                <tr>
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td>
                                                    <h5 style="padding:25px 0 0 0;color:#153643;font-family:Arial,sans-serif;font-size:16px;line-height:20px">Click to jion Aorta Group</h5>
                                                    <a style="padding:25px 0 0 0;color:#153643;font-family:Arial,sans-serif;font-size:16px;line-height:20px" href="<?php echo $link; ?>" target="_blank"><?php echo $link; ?></a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
