                ...
                <div class="card">
                    ...
                    <div class="card-body">
                       ...
                       <?php 
                            ...
                            <?php endif; ?>
                    <?php echo form_open_multipart('admin/add_fmember'); ?>
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="form-group">
                                        ...
                                        <select class="form-control select2-show-search border-bottom-0 w-100" name ="mobile" id ="mobile">
                                                        <optgroup label="Mobiles">
                                                        <option>Mobile no</option>
                                                        <?php if(!empty($patient_data)){ 
                                                            foreach($patient_data as $values ){
                                                        ?>
                                                        <option value="<?php echo $values['mobile']."-".$values['id'] ?>"><?php echo $values['mobile'] . " (" . $values['fname'] . " " . $values['lname'] . ")"; ?></option>
                                                        <?php } } ?>
                                                </optgroup>
                                        </select>
                                    </div>
