							...
							<div class="card-body">
								<div class="settings-tab">
									<ul class="tabs-menu nav">
										<li class=""><a href="#tab1" class="active" data-toggle="tab"><i class="si si-speedometer"></i> General</a></li>
										<li><a href="#tab2" data-toggle="tab" class=""><i class="si si-bubble"></i>  Chat</a></li>
										<li><a href="#tab3" data-toggle="tab" class=""><i class="si si-settings"></i>  Advanced</a></li>
									</ul>
											...
											<form class="form-horizontal" >
												...
												<div class="form-group ">
													<div class="row">
														...
														<div class="col-md-9">
															<label class="custom-switch d-inline-block mr-5">
																<input type="checkbox" name="custom-switch-checkbox" class="custom-switch-input">
																<span class="custom-switch-indicator"></span>
																<span class="custom-switch-description">On/Off</span>
															</label>
