									...
									<table class="table table-bordered table-hover mb-0 text-nowrap">
										...
										<tbody>
												...
												<td>
													<div class="media mt-0 mb-0">
														<div class="card-aside-img">
															<a href="#"></a>
															<img src="<?php echo base_url()?>/assets/images/products/h1.png" alt="img">
														</div>
											...
											<tr>
												...
												<td>
													<div class="media mt-0 mb-0">
														<div class="card-aside-img">
															<a href="#"></a>
															<img src="<?php echo base_url()?>/assets/images/products/j2.png" alt="img">
														</div>
														<div class="media-body">
															<div class="card-item-desc ml-4 p-0 mt-2">
											...
											<tr>
												...
												<td>
													<div class="media mt-0 mb-0">
														<div class="card-aside-img">
															<a href="#"></a>
															<img src="<?php echo base_url()?>/assets/images/products/h2.png" alt="img">
														</div>
														<div class="media-body">
															<div class="card-item-desc ml-4 p-0 mt-2">
											...
											<tr>
												...
												<td>
													<div class="media mt-0 mb-0">
														<div class="card-aside-img">
															<a href="#"></a>
															<img src="<?php echo base_url()?>/assets/images/products/f1.png" alt="img">
														</div>
														<div class="media-body">
															<div class="card-item-desc ml-4 p-0 mt-2">
											...
											<tr>
												...
												<td>
													<div class="media mt-0 mb-0">
														<div class="card-aside-img">
															<a href="#"></a>
															<img src="<?php echo base_url()?>/assets/images/products/l1.png" alt="img">
														</div>
														<div class="media-body">
															<div class="card-item-desc ml-4 p-0 mt-2">
											...
											<tr>
												...
												<td>
													<div class="media mt-0 mb-0">
														<div class="card-aside-img">
															<a href="#"></a>
															<img src="<?php echo base_url()?>/assets/images/products/h4.png" alt="img">
														</div>
														<div class="media-body">
															<div class="card-item-desc ml-4 p-0 mt-2">
											...
											<tr>
												...
												<td>
													<div class="media mt-0 mb-0">
														<div class="card-aside-img">
															<a href="#"></a>
															<img src="<?php echo base_url()?>/assets/images/products/j1.png" alt="img">
														</div>
														<div class="media-body">
															<div class="card-item-desc ml-4 p-0 mt-2">
											...
											<tr>
												...
												<td>
													<div class="media mt-0 mb-0">
														<div class="card-aside-img">
															<a href="#"></a>
															<img src="<?php echo base_url()?>/assets/images/products/f2.png" alt="img">
														</div>
														<div class="media-body">
															<div class="card-item-desc ml-4 p-0 mt-2">
											...
											<tr>
												...
												<td>
													<div class="media mt-0 mb-0">
														<div class="card-aside-img">
															<a href="#"></a>
															<img src="<?php echo base_url()?>/assets/images/products/v2.png" alt="img">
														</div>
														<div class="media-body">
															<div class="card-item-desc ml-4 p-0 mt-2">
											...
											<tr>
												...
												<td>
													<div class="media mt-0 mb-0">
														<div class="card-aside-img">
															<a href="#"></a>
															<img src="<?php echo base_url()?>/assets/images/products/v1.png" alt="img">
														</div>
														<div class="media-body">
															<div class="card-item-desc ml-4 p-0 mt-2">
											...
											<tr>
												...
												<td>
													<div class="media mt-0 mb-0">
														<div class="card-aside-img">
															<a href="#"></a>
															<img src="<?php echo base_url()?>/assets/images/products/f3.png" alt="img">
														</div>
														<div class="media-body">
															<div class="card-item-desc ml-4 p-0 mt-2">
											...
											<tr>
												...
												<td>
													<div class="media mt-0 mb-0">
														<div class="card-aside-img">
															<a href="#"></a>
															<img src="<?php echo base_url()?>/assets/images/products/j3.png" alt="img">
														</div>
														<div class="media-body">
															<div class="card-item-desc ml-4 p-0 mt-2">
											...
											<tr>
												...
												<td>
													<div class="media mt-0 mb-0">
														<div class="card-aside-img">
															<a href="#"></a>
															<img src="<?php echo base_url()?>/assets/images/products/h3.png" alt="img">
														</div>
														<div class="media-body">
															<div class="card-item-desc ml-4 p-0 mt-2">
											...
											<tr>
												...
												<td class="font-weight-semibold fs-16">$35,978</td>
												<td>
													<a href="#" class="badge badge-secondary">Out Of Stock</a>
												</td>
												<td>
													<a class="btn btn-success btn-sm text-white" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-pencil"></i></a>
													<a class="btn btn-danger btn-sm text-white" data-toggle="tooltip" data-original-title="Delete"><i class="fa fa-trash-o"></i></a>
												...
												<td>
													<div class="media mt-0 mb-0">
														...
														<div class="media-body">
															<div class="card-item-desc ml-4 p-0 mt-2">
																<a href="#" class="text-dark"><h4 class="font-weight-semibold">2Bk Delux Rooms</h4></a>
																<a href="#"><i class="fa fa-clock-o mr-1"></i> Nov-15-2018 , 12:45 pm</a><br>
																<a href="#"><i class="fa fa-tag mr-1"></i> Rent</a>
															</div>
														</div>
													</div>
													...
													<div class="media mt-0 mb-0">
														...
														<div class="media-body">
															<div class="card-item-desc ml-4 p-0 mt-2">
																...
																<a href="#"><i class="fa fa-clock-o mr-1"></i> Nov-15-2018 , 08:54</a><br>
																<a href="#"><i class="fa fa-tag mr-1"></i> Open</a>
															</div>
														</div>
													</div>
